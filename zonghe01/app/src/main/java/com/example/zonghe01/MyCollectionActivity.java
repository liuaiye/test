...
import leaf.collegeidleapp.bean.Collection;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lvMyCollection.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                builder.setTitle("提示:").setMessage("确定删除此收藏商品吗?").setIcon(R.drawable.ic_delete_24).setNegativeButton("取消", new DialogInterface.OnClickListener() {
                    @Override
