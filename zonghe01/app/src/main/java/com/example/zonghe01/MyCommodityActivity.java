...
import leaf.collegeidleapp.bean.Commodity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lvMyCommodity.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                builder.setTitle("提示:").setMessage("确认删除此商品项吗?").setIcon(R.drawable.ic_delete_24).setNegativeButton("取消", new DialogInterface.OnClickListener() {
                    @Override
